...
class DMemb(nn.Module):
    ...
    num_words: int
        Number of distinct words in a daset (i.e. vocabulary size).
    """
    def __init__(self,  num_docs, text_field, path): # vec_dim, num_docs, num_words)
        ...
        self._W = nn.Embedding.from_pretrained(torch.FloatTensor(text_field.vocab.vectors))
